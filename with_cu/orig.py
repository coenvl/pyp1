...
def getP1stuff():
	...
	process = subprocess.Popen('cu -l /dev/ttyUSB0 -s 115200 --parity=none 2> /dev/null', shell=True, stdout=subprocess.PIPE, bufsize=1, preexec_fn=os.setsid) # send stderr to /dev/null
